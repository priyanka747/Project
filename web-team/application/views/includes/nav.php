                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-id-badge"></i><a href="#">View Orders</a></li>
                            <li><i class="fa fa-bars"></i><a href="#">Add Orders</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="tables-basic.html">View Products</a></li>
                            <li><i class="fa fa-table"></i><a href="tables-data.html">Add Products</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-pie-chart"></i><a href="charts-peity.html">Clients Reports</a></li>
                        </ul>
                    </li>
